...
#ifndef FACEBOOKFRIENDSDATA_U
#define FACEBOOKFRIENDSDATA_U
...
/**
 * Transforms friend list to xml.
 * 
 * @param friends - the list of friends
 * @param filter - applied filter
 * @return  - string contains xml. later this xml 
 * will be transformed to html using XSLT template
 */
