...
/**
 * different utility functions deal with http requests are 
 * concentrated in HttpUtils namespace 
 */
namespace HttpUtils {
 ...
 *
 * @param httpRequest - http requst object that will send the request
 * @param targetURL - url to send the request
 * @param paramsString - possible post parameters
 * @param response - possible resaponce from the server
 */
